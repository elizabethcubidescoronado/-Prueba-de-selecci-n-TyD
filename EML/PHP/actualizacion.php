...
<body>
    ...
    <form method="post" action="update.php">
        <div>
            ...
            <input class="input" type="email" name="correo" id="correo" placeholder="Actualizar mediante correo" required>
        </div>
        <div>
            <label class="textp" for="id">Id:</label>
            <input class="input" type="text" name="id" id="id" placeholder="Id nuevo" required>
        </div>
        <div>
